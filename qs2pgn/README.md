...
Obviously we must agree on the order of moves. We use the order of the move list created by the JS library `chess.js`.
[To do: give details.]

We prefix this binary move list with a few leading bits specifying the version of the encoding (anticipating possible improvement! :-),
